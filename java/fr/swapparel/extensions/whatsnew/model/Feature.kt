package fr.swapparel.extensions.whatsnew.model
...
class Feature {
    ...
    constructor(@DrawableRes iconRes: Int, @ColorInt iconColor: Int,
                ...
                descriptionRes: String, @ColorInt descriptionTextColor: Int) {
    ...
    class Builder {
         ...
         *
         *  @param descriptionRes The chaîne mdrrr.
         */
        fun setDescriptionRes(descriptionRes: String) = apply { this.descriptionRes = descriptionRes }
